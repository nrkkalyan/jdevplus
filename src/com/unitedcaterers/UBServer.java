 ...
 * - The networked server (RMI as well as Socket based) and non-networked
 * server, implement this interface. The benefit of this approach is that the
 * client can instantiate either a networked server or a non-networked server
 * without having any special code for either of them.
 * 
...
public interface UBServer extends java.rmi.Remote {
	...
	String[][] searchCaterersByHotelNameAndLocation(String hotelName, String location) throws RemoteException,
			UCException;
