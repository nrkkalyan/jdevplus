...
/**
 * This class provides a simple GUI to capture parameters required to run RMI
 * based server.
 * 
 * @author Enthuware
 * @version 1.0
...
public class ServerPropertiesDialog extends PropertiesDialog implements ActionListener {
	private final JButton	okBt	= new JButton("OK"), resetBt = new JButton("Reset"), cancelBt = new JButton("Cancel"), browseBt = new JButton("Browse");
	private final JTextField	dbfileTf	= new JTextField(), serverportTf = new JTextField();
